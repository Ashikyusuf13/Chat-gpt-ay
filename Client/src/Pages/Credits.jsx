...
const CreditsSkeleton = () => {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 via-purple-50/50 to-indigo-50 dark:from-gray-950 dark:via-purple-950/20 dark:to-gray-900 overflow-y-auto">
      {/* Header Skeleton */}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 p-6">
      ...
      <div className="pt-16 pb-8 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-purple-100 dark:bg-purple-900/50 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-purple-700 dark:text-purple-300">Pricing</span>
          </div>
            ...
            <div className="mt-6 inline-flex items-center gap-3 px-5 py-2.5 bg-white/80 dark:bg-gray-800/80 rounded-full shadow-lg border border-purple-200/50 dark:border-purple-700/30">
              ...
              <div className="text-left">
                ...
                <p className="text-xl font-bold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">
                  {user.credits || 0} <span className="text-sm font-normal text-gray-500">credits</span>
                </p>
              </div>
            </div>
          )}
              ...
              >
                ...
                {styles.badge && !purchased && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className={`${styles.badgeColor} text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg`}>
                      {styles.badge}
                    </span>
                  </div>
                )}
                ...
                <div className="flex-1">
                  {/* Plan Icon & Name */}
                  <div className="flex items-center gap-3 mb-4">
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${styles.gradient} flex items-center justify-center text-2xl shadow-lg`}>
                      {styles.icon}
                    </div>
                    <div>
