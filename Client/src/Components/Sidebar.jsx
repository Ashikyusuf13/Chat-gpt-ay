...
const Sidebar = ({ openMenu, setOpenMenu }) => {
  ...
  return (
    <>
      ...
      <div
        className={`p-5 flex flex-col gap-2 border-r border-gray-300 dark:border-gray-700 h-screen w-70 min-md:w-72
      bg-gradient-to-b from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-black
      backdrop-blur-3xl max-md:absolute left-0 z-10 transition-all duration-500 ${
